...
public enum PeakTableColumnType {
    ...
    MASS("Mass", Double.class),
    MINUSMASSRULE("-Mass (Rule)", Double.class),
    MONOISOTOPICMASS("Monoisotopic mass", Double.class),
    HEIGHT("Height", Double.class),
    AREA("Area", Double.class),
    RTMIN("rt(min)", Double.class),
    RT("rt", Double.class),
    RTMAX("rt(max)", Double.class);

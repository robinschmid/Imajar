...
public class GeneralSettingsFrame extends JFrame {
  // MENUS
  private static final String CONVERTER_RAW = "Thermo RAW",
      GENERAL_VALUE_FORMATTING = "Value formatting";
  ...
  public GeneralSettingsFrame(Window window) {
    ...
    sl_contentPane.putConstraint(SpringLayout.NORTH, scrollPane, 5, SpringLayout.NORTH,
        contentPane);
    sl_contentPane.putConstraint(SpringLayout.WEST, scrollPane, 5, SpringLayout.WEST, contentPane);
    sl_contentPane.putConstraint(SpringLayout.SOUTH, scrollPane, 377, SpringLayout.NORTH,
        contentPane);
    contentPane.add(scrollPane);

    pnSettings = new JPanel();
    sl_contentPane.putConstraint(SpringLayout.NORTH, pnSettings, 5, SpringLayout.NORTH,
        contentPane);
    sl_contentPane.putConstraint(SpringLayout.SOUTH, pnSettings, -5, SpringLayout.SOUTH,
        contentPane);
    sl_contentPane.putConstraint(SpringLayout.EAST, scrollPane, -6, SpringLayout.WEST, pnSettings);
    sl_contentPane.putConstraint(SpringLayout.WEST, pnSettings, 152, SpringLayout.WEST,
        contentPane);
    sl_contentPane.putConstraint(SpringLayout.EAST, pnSettings, -5, SpringLayout.EAST, contentPane);

    // Tree Model
    DefaultTreeModel model = new DefaultTreeModel(new DefaultMutableTreeNode("General") {
      {
  ...
  private void generateSettingsPanel() {
    ...
    // Visual
    PnVisualSpectraLabelGeneratorSettings pnVisualSpectraLabelGen =
        new PnVisualSpectraLabelGeneratorSettings();

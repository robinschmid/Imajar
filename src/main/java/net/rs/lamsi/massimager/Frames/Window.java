...
public class Window {
  ...
  protected void setNewFileSelectedInMode(int selectedIndex) {
    ...
    if (currentMode == MODE_MS)
      runner.setNewFileSelectedAndShowAll(selectedIndex);
  }
  ...
  private void createMenu() {
    ...
    menuItem.getAccessibleContext()
        .setAccessibleDescription("Saves all data related parameters to a file");
    menuItem.setToolTipText(menuItem.getAccessibleContext().getAccessibleDescription());
    menuItem.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent arg0) {
    ...
    menuItem.getAccessibleContext()
        .setAccessibleDescription("Loades all data related parameters from a file");
    menuItem.setToolTipText(menuItem.getAccessibleContext().getAccessibleDescription());
    menuItem.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent arg0) {
    ...
    mntmGraphicsSettings
        .setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P, ActionEvent.ALT_MASK));
    mntmGraphicsSettings.getAccessibleContext()
        .setAccessibleDescription("Opens the gradient settings");
    mntmGraphicsSettings
        .setToolTipText(mntmGraphicsSettings.getAccessibleContext().getAccessibleDescription());
    ...
    mntmGraphicsSettings
        .setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P, ActionEvent.ALT_MASK));
    mntmGraphicsSettings.getAccessibleContext()
        .setAccessibleDescription("Opens the Plot-setup frame");
    mntmGraphicsSettings
        .setToolTipText(mntmGraphicsSettings.getAccessibleContext().getAccessibleDescription());
    mntmGraphicsSettings.addActionListener(new ActionListener() {
      @Override
    ...
    mntmSaveGraphicsSettings
        .setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_5, ActionEvent.ALT_MASK));
    mntmSaveGraphicsSettings.getAccessibleContext()
        .setAccessibleDescription("Save all graphics related parameters in a file");
    mntmSaveGraphicsSettings
        .setToolTipText(mntmSaveGraphicsSettings.getAccessibleContext().getAccessibleDescription());
    ...
    mntmLoadGraphicsSettings
        .setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_6, ActionEvent.ALT_MASK));
    mntmLoadGraphicsSettings.getAccessibleContext()
        .setAccessibleDescription("Loads all graphics related parameters from a file");
    mntmLoadGraphicsSettings
        .setToolTipText(mntmLoadGraphicsSettings.getAccessibleContext().getAccessibleDescription());
    ...
    menuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_G, ActionEvent.ALT_MASK));
    menuItem.getAccessibleContext()
        .setAccessibleDescription("General settings for converters and other stuff");
    menuItem.setToolTipText(menuItem.getAccessibleContext().getAccessibleDescription());
    menuItem.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent arg0) {
  ...
  // ###############################################################################
  // SAVE AND LOAD FILES
  public boolean saveDataFile(SettingsDataSaver setDataSaver, XSSFExcelWriterReader excelWriter,
      int currentMode) throws Exception, NoFileSelectedException {
  ...
  public static File getPathOfJar() {
    ...
    try {
      File jar = new File(
          Window.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath());
  ...
  public static void showErrorDialog(String title, String message) {
    JOptionPane.showMessageDialog(getWindow().getFrame(), message, title,
        JOptionPane.ERROR_MESSAGE);
  }

  public static boolean showDialogYesNo(String title, String text) {
    Object[] options = {"Yes", "No"};
    int n = JOptionPane.showOptionDialog(getWindow().getFrame(), text, title,

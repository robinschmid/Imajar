...
public class ModulePaintscaleTheme
    extends Collectable2DSettingsModule<SettingsPaintscaleTheme, Collectable2D> {
    ...
    if (t != null) {
      try {
        RectangleInsets r = new RectangleInsets(doubleFromTxt(getTxtPSMarginTop()),
            doubleFromTxt(getTxtPSMarginLeft()), doubleFromTxt(getTxtPSMarginBottom()),
            doubleFromTxt(getTxtPSMarginRight()));
        // setall

...
public class ModuleSplitContinousImage
    extends Collectable2DSettingsModule<SettingsImageContinousSplit, Image2D> {
  ...
  public void setAllViaExistingSettings(SettingsImageContinousSplit st) {
    if (st != null) {
      ...
      if (st.getSplitMode() == XUNIT.DP)
        ...
        getTxtSplitValue().setText(String.valueOf(st.getSplitAfterX()));

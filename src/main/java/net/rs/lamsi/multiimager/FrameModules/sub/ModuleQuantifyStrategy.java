	...
	public ModuleQuantifyStrategy(ImageEditorWindow wnd) {
		...
		btnShowRegression2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(imgEx != null) {
					SettingsSelections s = (SettingsSelections)imgEx.getSettingsByClass(SettingsSelections.class);
					DialogLinearRegression d = DialogLinearRegression.createInstance(s.getRegressionData(), true);
					d.setVisible(true);
				}
			}
		});

...
public class ModuleScaleInPlot
    extends Collectable2DSettingsModule<SettingsScaleInPlot, Collectable2D> {
  ...
  public SettingsScaleInPlot writeAllToSettings(SettingsScaleInPlot s) {
    if (s != null) {
      try {
        s.setAll(getCbShowScale().isSelected(), getTxtScaleUnit().getText(),
            floatFromTxt(getTxtScaleFactor()), floatFromTxt(getTxtScaleValue()),

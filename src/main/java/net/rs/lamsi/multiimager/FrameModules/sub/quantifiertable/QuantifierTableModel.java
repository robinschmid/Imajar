...
public class QuantifierTableModel extends AbstractTableModel {
  ...
  public boolean isCellEditable(int row, int col) {
    ...
    return ((columnType == QuantifierTableColumnType.MODE)
        || (columnType == QuantifierTableColumnType.CONC)
        || (columnType == QuantifierTableColumnType.PARENT)
        || (columnType == QuantifierTableColumnType.SELECT));
  }

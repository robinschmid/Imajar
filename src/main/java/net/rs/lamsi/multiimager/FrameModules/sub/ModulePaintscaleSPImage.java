...
public class ModulePaintscaleSPImage
    extends Collectable2DSettingsModule<SettingsPaintScale, SingleParticleImage> {
  // ################################################################################################
  // MY STUFF
   ...
   * Create the panel.
   */
  public ModulePaintscaleSPImage() {
    super("Paintscale", false, SettingsPaintScale.class, SingleParticleImage.class);
  ...
  @Override
  public void setCurrentImage(SingleParticleImage img, boolean setAllToPanel) {

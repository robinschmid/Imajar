...
//    BufferedReader in;
     ...
     * @param file
     * @param encoding as String (given by UniversalDetector.detectCharset(file); juniversalchardet) null for standard encoding
     * @return
     */
    public Vector<String> readLines(File file, String encoding) { 
        Vector<String> sList = new Vector<String>();
        try {
          if(encoding!=null) scanner = new Scanner(file, encoding);
    ...
    public Vector<String> readLinesBuffered(File file, String encoding) throws IOException { 
        ...
        try {
        	...
        	if(encoding!=null) br = new BufferedReader(new InputStreamReader(new FileInputStream(file), encoding));
     ...
     * if files are the same returns true
     * @param file
     * @param file2
     * @return
     * @throws Exception 

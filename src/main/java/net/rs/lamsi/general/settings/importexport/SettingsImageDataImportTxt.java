...
public class SettingsImageDataImportTxt extends Settings {
  ...
  public static enum IMPORT {
    MULTIPLE_FILES_LINES_TXT_CSV, ONE_FILE_2D_INTENSITY, CONTINOUS_DATA_TXT_CSV, PRESETS_SHIMADZU_ICP_MS, PRESETS_SHIMADZU_ICP_MS_2, PRESETS_THERMO_iCAPQ, PRESETS_THERMO_iCAPQ_ONE_ROW, PRESETS_THERMO_NEPTUNE;
  }

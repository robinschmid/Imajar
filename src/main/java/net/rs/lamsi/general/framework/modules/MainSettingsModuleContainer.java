...
import net.rs.lamsi.multiimager.FrameModules.sub.ModuleAlphaMap;

/**
 * the main settings container for each collectable2d subclass (image2d, imageoverlay) holds
 * multiple Collectable2DSettingsModules or HeatmapSettingsModules or basic Modules replaces the
 * title with buttons and auto updating checkbox
 * 
 * @author r_schm33
 *
 * @param <T> Settings
...
public abstract class MainSettingsModuleContainer<T extends SettingsContainerSettings, S extends Collectable2D>
  ...
  private ModuleAlphaMap modAlphaMap;
  ...
  public MainSettingsModuleContainer(String title, boolean westside, Class settc, Class objclass) {
    ...
    modAlphaMap = new ModuleAlphaMap();
    addModule(modAlphaMap);

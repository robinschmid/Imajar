...
/**
 * this is a placeholder that is inserted when settings which contain links 
 * to other collectable2Ds are imported 
 * Placeholder is replaced later
 * @author r_schm33
 *
 */
public class Collectable2DPlaceHolderLink  extends Collectable2D<SettingsCollectable2DPlaceHolder> implements Serializable {	 

...
public class ChartGesture {
  ...
  public boolean equals(Object obj) {
		if (!(obj instanceof ChartGesture)) {
			...
			return this.getEntity().equals(g.getEntity()) && this.getEvent().equals(g.getEvent()) && this.getButton().equals(g.getButton()) && this.getKey().equals(g.getKey());
		}
  }
  ...
  public enum Key {
     ...
     * @return
     */
    public static Key fromList(Key[] keys) {
      return fromList(Arrays.asList(keys));
    }

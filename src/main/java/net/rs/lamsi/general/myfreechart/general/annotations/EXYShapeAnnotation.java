...
public class EXYShapeAnnotation extends AbstractXYAnnotation
   ...
   */
  public EXYShapeAnnotation(Shape shape) {
    this(shape, new BasicStroke(1.0f), Color.BLACK);
  }

  /**
   * Creates a new annotation where the shape is drawn as an outline using the specified
   * {@code stroke} and {@code outlinePaint}.
   *
   * @param shape the shape ({@code null} not permitted).
   * @param stroke the shape stroke ({@code null} permitted).
   * @param outlinePaint the shape color ({@code null} permitted).
   */
  public EXYShapeAnnotation(Shape shape, Stroke stroke, Paint outlinePaint) {
   ...
   */
  public EXYShapeAnnotation(Shape shape, Stroke stroke, Paint outlinePaint, Paint fillPaint) {
    super();
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof EXYShapeAnnotation)) {
      return false;
    }
    EXYShapeAnnotation that = (EXYShapeAnnotation) obj;
